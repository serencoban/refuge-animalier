...
<header class="header">
    <nav class="header__navbar">
        ...
        <ul class="header__navbar__menu">
            ...
            <li class="header__navbar__menu-item"><a class="header__link" href="{{ __('/animals.index') }}">Devenir bénévole</a></li>
        ...
        <div id="menuToggle">
            ...
            <div role="navigation" id="mobileMenu" class="sidenav" aria-hidden="true">
                <ul class="menu">
                    ...
                    <li class="menu-item"><a href="{{ __('/animals.index') }}">Devenir bénévole</a></li>
